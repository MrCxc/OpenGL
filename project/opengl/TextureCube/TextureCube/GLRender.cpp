...
void initGL(void)
{
	...
	const GLchar *fragmentShader = " \
				...
				void main()\n \
				{ \n\
					vec2 uvCoord = vec2(v_texcoord0.x, 1.0-v_texcoord0.y) + u_uvOffset;\
					vec4 tex_color = texture(u_texture0, vec2(v_texcoord0.x, 1.0-v_texcoord0.y));\
					vec4 tex_color1 = texture(u_texture1, uvCoord);\
					out_color =  tex_color + vec4(tex_color1.rgb, 1.0f)*0.7;\n \
				} \n";
	...
	//imageData = SOIL_load_image("Resources/fen.jpg", &texw, &texh, NULL, SOIL_LOAD_RGBA);
	imageData = SOIL_load_image("Resources/fire.jpg", &texw, &texh, NULL, SOIL_LOAD_RGBA);
...
void render(float time)
{
	...
	location = glGetUniformLocation(program, "u_texture1");
